...
function applyTheme(theme, save = true) {
  ...
  // Correctly update Material Symbols span text & FontAwesome icons if present
  document.querySelectorAll('[data-theme-toggle]').forEach((button) => {
    const spanIcon = button.querySelector('.material-symbols-rounded');
    if (spanIcon) {
      spanIcon.textContent = isDark ? 'light_mode' : 'dark_mode';
    }
  ...
  // Update Dashboard specific theme icon IDs if present
...
// ============================================================
// DYNAMIC MOBILE TOGGLE INJECTOR (<= 340px)
// ============================================================
